...
// Expected: true (same multiset of children {2,3}, order doesn't matter)
...
// Expected: 2 (replace 2->4 costs 1, delete leaf 3 costs treeSize(3)=1, total 2)
...
module.exports = { areTreesIdentical, treeEditDistance };
