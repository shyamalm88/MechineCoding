/**
 * ============================================================================
 * PROBLEM: Two City Scheduling (LeetCode #1029)
 * ============================================================================
...
// ============================================================================
// APPROACH: Sort by the REGRET of Sending Someone to B Instead of A
// ============================================================================
/**
 * STORY / INTUITION:
 ...
 *
 * DRY RUN: [[10,20],[30,200],[400,50],[30,20]]
...
const twoCitySchedCost = (costs) => {
  // Most negative (a - b) first = strongest preference for city A.
...
// TEST CASES
// ============================================================================
console.log("=== Two City Scheduling Tests ===\n");

console.log("Test 1:", twoCitySchedCost([[10, 20], [30, 200], [400, 50], [30, 20]])); // Expected: 110
console.log("Test 2:", twoCitySchedCost([[259, 770], [448, 54], [926, 667], [184, 139], [840, 118], [577, 469]])); // Expected: 1859
console.log("Test 3:", twoCitySchedCost([[10, 20], [30, 40]]));   // Expected: 50 (10 + 40)
console.log("Test 4:", twoCitySchedCost([[5, 5], [5, 5]]));       // Expected: 10 (ties)
