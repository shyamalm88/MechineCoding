...
// ============================================================================
// APPROACH: Simulate row placement with a bouncing pointer
// ============================================================================
/**
 * STORY / INTUITION:
...
const convert = (s, numRows) => {
  ...
  for (const char of s) {
    ...
    // Bounce off the top or bottom row
...
// TEST CASES
// ============================================================================
console.log("=== Zigzag Conversion Tests ===\n");
...
console.log("Test 3:", convert("A", 1));              // Expected: "A"
console.log("Test 4:", convert("AB", 1));             // Expected: "AB"
